class TuberTui < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tuberq/tuber-tui/releases/download/v0.7.2/tuber-tui-aarch64-apple-darwin.tar.gz"
      sha256 "7b8ddebc785d2f4e24a401fdb2f0e27266338064394e7158cddb7e741536053a"
    end
    on_intel do
      url "https://github.com/tuberq/tuber-tui/releases/download/v0.7.2/tuber-tui-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/tuberq/tuber-tui/releases/download/v0.7.2/tuber-tui-aarch64-unknown-linux-musl.tar.gz"
      sha256 "c806dace01fcd894aaddf42ce94ca8dfbc2c1386284520ea8201cc19fd473014"
    end
    on_intel do
      url "https://github.com/tuberq/tuber-tui/releases/download/v0.7.2/tuber-tui-x86_64-unknown-linux-musl.tar.gz"
